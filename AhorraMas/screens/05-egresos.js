    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={styles.card}>
          <Text style={styles.cardText}>Alimentos <Text style={{ color: '#FF7A7A' }}>$762.00</Text></Text>
        </View>
        <View style={styles.card}>
          <Text style={styles.cardText}>Alquiler <Text style={{ color: '#FFC400' }}>$6000.00</Text></Text>
        </View>
        <View style={styles.card}>
          <Text style={styles.cardText}>Restaurante <Text style={{ color: '#FFB03A' }}>$527.00</Text></Text>
        </View>
      </ScrollView>
