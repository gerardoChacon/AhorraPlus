...
import { obtenerTransaccionesPorCategoria, obtenerIngresosPorMes, obtenerEgresosPorMes } from "../controllers/transaccion.controller";
...
export default function HomeScreen() {
  ...
  const cuentasChartData = {
    ...
    colors: accounts.length > 0 ? accounts.map((a) => a.color) : ["#999999"],
  };

  // Gráfica comparativa de ingresos vs egresos del mes
  const comparativaDelMesChartData = {
    labels: ["Ingresos", "Egresos"],
    datasets: [
      {
        data: [ingresosDelMes, Math.abs(egresosDelMes)],
      },
    ],
    colors: ["#07DF90", "#F10004"],
  };
