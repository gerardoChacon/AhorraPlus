      ...
      <ScrollView contentContainerStyle={styles.body}>
        ...
        <View style={styles.totalCard}>
          <View style={styles.totalCardContent}>
            <Text style={styles.totalLabel}>Ingresos del mes</Text>
            <Text style={styles.totalAmount}>{formatCurrency(total)}</Text>
          </View>
          <View style={styles.totalCardIcon}>
            <MaterialCommunityIcons name="trending-up" size={32} color="#07DF90" />
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          {lista.length > 0 ? (
              ...
              <View key={item.id} style={[styles.transactionCard, index === lista.length - 1 && styles.transactionCardLast]}>
                <View style={styles.transactionLeft}>
                  <View style={styles.transactionIcon}>
                    <MaterialCommunityIcons name="cash-plus" size={20} color="#07DF90" />
                  </View>
                  <View>
                ...
                <View style={styles.transactionRight}>
                  ...
                  <TouchableOpacity onPress={() => deleteIngreso(item.id)} style={styles.deleteButton}>
            ...
            <View style={styles.emptyState}>
              ...
              <Text style={styles.emptyStateText}>No hay ingresos registrados</Text>
            </View>
          )}
        </View>
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity style={styles.buttonSave} onPress={addIngreso}>
